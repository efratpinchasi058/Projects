...
const initialState = {
    //רשימת משתמשים
    managerUser: [
        { nameManager: 'batsheva', tzManager:'214942393',passwordManager:'bat123!'}, 
    ],
    users:[
        {id:'123',username:'efrat',tz:'1',phon:'0548549577',password:'123',CreditCard:'4580174404628849',validity:'02/85',cvv:'123',typeCode:'1'},
        {id:'000',username:'elisheva',tz:'329212146',phon:'0583268448',password:'000',CreditCard:'1234567891234567',validity:'02/23',cvv:'000',typeCode:'1'},
        {id:'111',username:'pnina',tz:'214661853',phon:'0583241389',password:'111',CreditCard:'1254896712398451',validity:'02/11',cvv:'111',typeCode:'2'},  
        ],
    currentUser: {},
    //סוג רכב
    cartype: [
        ...
        // רכבים: הצגת כל הרכבים. יש להציג פרטי דגם (חברה, מודל וסוג רכב) מס' מקומות, מיקום. יש לסמן רכב פנוי בירוק, תפוס באדום. יש
        ...
        cars:[
                ...
                {codeCars:"2",licenseNumber:"987-654-403",modelCode:"2",Numberofplaces:"7",Image:"EQC.PNG",yearbook:"2024",AutomaticOrManual:false,DriveTypeCode:"1" ,codeType:"1",pricePerHour:"60",ConsumptionPerKilometer:"18",BalanceInLiters:"6",Street:"hayarkon",city:"jerusalem",isvacant:"false"},
                {codeCars:"3",licenseNumber:"654-321-903",modelCode:"3",Numberofplaces:"5",Image:"EQS.PNG",yearbook:"2023",AutomaticOrManual:true,DriveTypeCode:"2",codeType:"1", pricePerHour:"40",ConsumptionPerKilometer:"14",BalanceInLiters:"4",Street:"sderot",city:"tel-aviv",isvacant:"true"}, 
    ...
    switch (action.type) {
        ...
        case 'ADD_CAR':
            ...
            case 'UPDATE_CAR_STATUS':
                const { codeCars, status, rentDate, rentTime } = action.payload;
                const car = state.cars.find(c => c.codeCars === codeCars);
                const rent = {rentCode: rentCounter, returnDate: rentDate, returnTime: rentTime}
                // const rent = state.rent.find(r => r.carCode === carCode)
                if (car) {
                    
                    car.isvacant = status;
                    if(status ==='false'){
                        
                        car.rentDate = rentDate
                        car.rentTime = rentTime
                        car.rentCode = generateRentCode()
                    }
                    else{
                        car.rentDate = null
                        car.rentTime = null
